import { BUDGET_RULES, COLLABORATION_RULES, COMPANY_SPECIALTIES, TERRAFORMING_TARGETS } from "./config.js?v=15";
import {
...
import {
  ...
  signedPercent
} from "./aiEvaluator.js?v=16";
import { requireCompanyAccess } from "./companyAuth.js?v=6";
