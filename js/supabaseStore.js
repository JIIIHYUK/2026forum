...
const splitState = (state) => {
  const publicState = stripPrivateFields(clone(state));
  ...
  return [
    ...
    { id: segmentId("companies"), state: { companies: publicState.companies || [] }, updated_at: new Date().toISOString() },
    { id: segmentId("projects"), state: { projects: publicState.projects || [] }, updated_at: new Date().toISOString() },
    { id: segmentId("politics"), state: { politics: publicState.politics || {} }, updated_at: new Date().toISOString() },
    {
      id: segmentId("collaboration"),
      state: { collaborationOffers: publicState.collaborationOffers || [] },
...
const fallbackStateRow = (state) => ({
  ...
  state: stripPrivateFields(clone(state)),
  updated_at: new Date().toISOString()
});
