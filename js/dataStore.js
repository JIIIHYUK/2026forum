import { BUDGET_RULES, COLLABORATION_RULES, COMPANIES, RESOURCE_DELIVERY_RULES, RESOURCE_RULES } from "./config.js?v=14";
import {
...
export function buyPendingProjectResource(companyId, pendingProjectId, resourceId, source = "planet") {
  ...
  if (!isResourceAvailableFrom(resourceId, source)) {
    return { state: currentState(), purchased: false, reason: "이 행성에서는 해당 자원을 구매할 수 없습니다." };
  }
